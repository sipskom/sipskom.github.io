                        ...
                        <form action="<?=site_url('service/proses') ?>" method="post">
                            <div class="row">
                                ...
                                <div class="form-group" style="margin-left: 50px;">
                                    ...
                                    <select style="width: 210px;" id="id_customer" name="id_customer" class="form-control">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group" style="margin-left: 50px;">
                                    ...
                                    <input type="text" value="" name="nama_barang" id="nama_barang" class="form-control" required> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <label for=""> Kelengkapan </label>
                                    <textarea name="kelengkapan" id="kelengkapan" cols="23" rows="2" class="form-control"></textarea>
                                </div>
                                <div class="form-group" style="margin-left: 50px;">
                                    <label for=""> Keluhan </label>
                                    <textarea name="keluhan" id="keluhan" cols="23" rows="2" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <label for=""> Kerusakan </label>
                                    <textarea name="kerusakan" id="kerusakan" cols="23" rows="2" class="form-control"></textarea>
                                </div>
                                <div class="form-group" style="margin-left: 50px;">
                                    <label for=""> Sparepart </label>
                                    <textarea name="sparepart" id="sparepart" cols="23" rows="2" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
