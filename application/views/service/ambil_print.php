        ...
        <div class="content">
            ...
            <div class="transaction">
                <table class="transaction-table" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td colspan="2"></td>
                            <td style=" text-align:left; padding-top:5px">Dibayarkan</td>
                            <td  style=" text-align:right; padding-top:5px"><?=$row->dibayarkan?></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td style="border-top: 1px dashed; text-align:left; padding-top:5px">Kembalian</td>
                            <td  style="border-top: 1px dashed; text-align:right; padding-top:5px"><?=$row->kembalian?></td>
                        </tr>
                </table>
            </div>
            <div class="thanks">
