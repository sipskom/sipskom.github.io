...
<div class="content-header">
    ...
    <div class="content">
        <div class="card card-indigo card-outline">
            ...
            <button target="_blank" onclick="window.open('<?=site_url('laporan/stok/in/by_full')?>','_blank')" name="cetak" id="cetak" style="display: block; margin-top: 10px ; margin-left: 35px" class="btn btn-flat btn-success"><i class="fa fa-print"></i> Cetak</button>    
            </div>
            <div id="filtgl" style="display: none; margin-top: 10px">
                <form method="POST" action="<?= site_url('laporan/stok/in/by_tgl') ?>" target="_blank">
            ...
            <div id="filbln" style="display: none; margin-top: 10px">
                <form method="POST" action="<?= site_url('laporan/stok/in/by_bln') ?>" target="_blank">
            ...
            <div id="filthn" style="display: none; margin-top: 10px">
                <form method="POST" action="<?= site_url('laporan/stok/in/by_thn') ?>" target="_blank">
          ...
          <?php foreach ($result as $key => $data) { ?>
						<tr>
							...
							<td class="text-center"><?= date('m/d/Y', strtotime($data->waktu_stokin)) ?></td>
							<td><?= $data->barcode ?></td>
