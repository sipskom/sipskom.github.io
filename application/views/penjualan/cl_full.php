<html moznomarginboxes mozdisallowselectionprint>
    ...
    <body onload="window.print()">  
      ...
      <article >Jl. Simpang Sungai Bilu No. 18 RT. 06 Banjarmasin Tengah, Banjarmasin 70121</article>
            ...
            <h4 style="font-size: 16px;text-align:center">Laporan Penjualan</h4>    
            <table>
				<thead>
					<tr>
          ...
          <?php foreach ($result as $key => $data) { ?>
						<tr>
                            ...
                            <td style="text-align:right"><?= rp($data->diskon_barang) ?></td>
                            <td style="text-align:right"><?= rp($data->subtotal) ?></td>
				...
				<tfoot>
					...
					<tr>
                    <td colspan="12" style="color: blue; text-align: right;">
							<?php foreach ($grand_total as $key => $data) { ?>
								<?= rp($data->grand_total) ?>
							<?php } ?>
						</td>
						<td colspan="13" style="width: 120px;text-align: center;">
